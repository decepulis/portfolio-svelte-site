<script lang="ts">
	...
	const browsY = $derived.by(() => {
		...
		return browsYPoked + browsYMouse;
	});
...
>
	...
	<g style="transform:translate3d({earsX}px,{earsY}px,0);">
		<!-- left ear -->
		<g>
			<path fill="wheat" d="M46 31h5v5h-5z" />
			<path
		...
		<!-- right ear -->
		<g>
			<path fill="wheat" d="M12 31h5v5h-5z" />
			<path
